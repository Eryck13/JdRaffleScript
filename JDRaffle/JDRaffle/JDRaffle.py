...
def main():#'✓'
    ...
    catchall = input('input your domain with @')
    ...
    #ranaddy = [ranaddy.replace(' ', '') for ranaddy in ranaddy]     

    ranaddy2 = open('addy2jug.txt', 'rt').read().splitlines()
    #ranaddy2 = [ranaddy2.replace(' ', '') for ranaddy2 in ranaddy2]     
    ...
    for i in range(int(amount)): 
        ...
        user2 = random.choice(ranfname)
        domainfinal = user2 + str(random.randint(1,10000)) + catchall
        ...
        ranaddyfinish = ranaddyfinish[:9] + randletter.lower() + ranaddyfinish[9:]
        ...
        addyfinish = ranaddyfinish + randletter2.lower()
